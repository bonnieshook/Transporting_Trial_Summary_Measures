...
Sc1<-as.data.frame(read.csv("01_simulation_results_scen1_RR_ST.csv"))
Sc2<-as.data.frame(read.csv("02_simulation_results_scen2_RR_ST.csv"))
Sc3<-as.data.frame(read.csv("03_simulation_results_scen3_RR_ST.csv"))
Sc4<-as.data.frame(read.csv("04_simulation_results_scen4_RR_ST.csv"))
Sc5<-as.data.frame(read.csv("05_simulation_results_scen5_RR_ST.csv"))
...
# save to a text file
writeLines(Latex.tab, "Latex.tab.n1500.txt")

write.csv(Latex.tab, "06_SimSummary_table_RR_ST_n1500.csv")
