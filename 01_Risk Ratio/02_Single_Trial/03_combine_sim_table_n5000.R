...
Sc1<-as.data.frame(read.csv("01_simulation_results_scen1_RR_ST_largen.csv"))
Sc2<-as.data.frame(read.csv("02_simulation_results_scen2_RR_ST_largen.csv"))
Sc3<-as.data.frame(read.csv("03_simulation_results_scen3_RR_ST_largen.csv"))
Sc4<-as.data.frame(read.csv("04_simulation_results_scen4_RR_ST_largen.csv"))
Sc5<-as.data.frame(read.csv("05_simulation_results_scen5_RR_ST_largen.csv"))
...
# save to a text file
writeLines(Latex.tab, "Latex.tab.n5000.txt")

write.csv(Latex.tab, "06_SimSummary_table_RR_ST_n5000.csv")
