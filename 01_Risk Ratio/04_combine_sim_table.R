...
Sc1.mod<-as.data.frame(read.csv("01_simulation_results_scen1_RR_meta_mod.csv"))
Sc2.mod<-as.data.frame(read.csv("02_simulation_results_scen2_RR_meta_mod.csv"))
Sc3.mod<-as.data.frame(read.csv("03_simulation_results_scen3_RR_meta_mod.csv"))
Sc4.mod<-as.data.frame(read.csv("04_simulation_results_scen4_RR_meta_mod.csv"))
Sc5.mod<-as.data.frame(read.csv("05_simulation_results_scen5_RR_meta_mod.csv"))

Sc1.strong<-as.data.frame(read.csv("01_simulation_results_scen1_RR_meta_strong.csv"))
Sc2.strong<-as.data.frame(read.csv("02_simulation_results_scen2_RR_meta_strong.csv"))
Sc3.strong<-as.data.frame(read.csv("03_simulation_results_scen3_RR_meta_strong.csv"))
Sc4.strong<-as.data.frame(read.csv("04_simulation_results_scen4_RR_meta_strong.csv"))
Sc5.strong<-as.data.frame(read.csv("05_simulation_results_scen5_RR_meta_strong.csv"))
...
write.csv(all_scen, "04_SimSummary_table_RR_primary.csv")
...
# save to a text file
writeLines(Latex.tab, "Latex.tab.RR.prim.txt")
...
write.csv(all_scen_naive, "04_SimSummary_table_RR_primary_naive.csv")
...
# save to a text file
writeLines(Latex.tab_naive, "Latex.tab.RR.prim.naive.txt")
