...
Scenario<-1
outfile <- "01_simulation_results_scen1_RR.csv"
setwd("<name of directory>")
source("01_sims.R")
rm(list = ls())

Scenario<-2
outfile <- "02_simulation_results_scen2_RR.csv"
setwd("<name of directory>")
source("01_sims.R")
rm(list = ls())

Scenario<-3
outfile <- "03_simulation_results_scen3_RR.csv"
setwd("<name of directory>")
source("01_sims.R")
rm(list = ls())

Scenario<-4
outfile <- "04_simulation_results_scen4_RR.csv"
setwd("<name of directory>")
source("01_sims.R")
rm(list = ls())

Scenario<-5
outfile <- "05_simulation_results_scen5_RR.csv"
setwd("<name of directory>")
source("01_sims.R")
rm(list = ls())
