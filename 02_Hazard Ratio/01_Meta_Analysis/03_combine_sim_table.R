...
Sc1<-as.data.frame(read.csv("01_simulation_results_scen1_HR.csv"))
Sc2<-as.data.frame(read.csv("02_simulation_results_scen2_HR.csv"))
Sc3<-as.data.frame(read.csv("03_simulation_results_scen3_HR.csv"))
Sc4<-as.data.frame(read.csv("04_simulation_results_scen4_HR.csv"))
Sc5<-as.data.frame(read.csv("05_simulation_results_scen5_HR.csv"))
...
all_scen<-rbind(Sc1.res,Sc2.res,Sc3.res)
...
write.csv(all_scen, "06_SimSummary_table_HR.csv")
...
write.csv(all_scen_naive, "06_SimSummary_table_naive_HR.csv")
