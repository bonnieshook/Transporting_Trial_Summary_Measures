################################################################################
# Program: 01_sims.R
# Purpose: Simulation study for transportability paper; code to run sims for all scenarios (hazard ratio scenarios) - single trial
