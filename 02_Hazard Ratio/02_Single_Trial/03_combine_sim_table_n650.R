...
Sc1<-as.data.frame(read.csv("01_simulation_results_scen1_HR_ST_smalln.csv"))
Sc2<-as.data.frame(read.csv("02_simulation_results_scen2_HR_ST_smalln.csv"))
Sc3<-as.data.frame(read.csv("03_simulation_results_scen3_HR_ST_smalln.csv"))
Sc4<-as.data.frame(read.csv("04_simulation_results_scen4_HR_ST_smalln.csv"))
Sc5<-as.data.frame(read.csv("05_simulation_results_scen5_HR_ST_smalln.csv"))
...
# save to a text file
writeLines(Latex.tab, "Latex.tab.HR.n650.txt")

write.csv(Latex.tab, "06_SimSummary_table_HR_ST_n650.csv")
