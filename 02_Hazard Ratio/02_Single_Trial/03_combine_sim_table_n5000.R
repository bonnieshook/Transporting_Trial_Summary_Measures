...
# Purpose: Simulation study for transportability paper (hazard ratio scenarios) - single trial: Combine Sim results and output table 
...
Sc1<-as.data.frame(read.csv("01_simulation_results_scen1_HR_ST_largen.csv"))
Sc2<-as.data.frame(read.csv("02_simulation_results_scen2_HR_ST_largen.csv"))
Sc3<-as.data.frame(read.csv("03_simulation_results_scen3_HR_ST_largen.csv"))
Sc4<-as.data.frame(read.csv("04_simulation_results_scen4_HR_ST_largen.csv"))
Sc5<-as.data.frame(read.csv("05_simulation_results_scen5_HR_ST_largen.csv"))
...
all_scen<-as.data.frame(rbind(Sc1.res,Sc2.res))
...
# save to a text file
writeLines(Latex.tab, "Latex.tab.HR.n5000.txt")

write.csv(Latex.tab, "06_SimSummary_table_HR_ST_n5000.csv")
